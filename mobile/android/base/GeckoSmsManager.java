  ...
  implements ISmsManager
{
  ...
  public void start() {
    ...
    Gecko.instance.getContext().registerReceiver(this, smsFilter);
  }
    ...
    try {
      ...
      if (aMessage.length() <= kMaxMessageSize) {
        ...
        PendingIntent sentPendingIntent =
          PendingIntent.getBroadcast(Gecko.instance.getContext(),
  ...
  public int saveSentMessage(String aRecipient, String aBody, long aDate) {
    ...
    try {
      ...
      ContentResolver cr = Gecko.instance.getContext().getContentResolver();
  ...
  public void stop() {
    Gecko.instance.getContext().unregisterReceiver(this);
  }
