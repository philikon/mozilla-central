...
function asyncResponse() {
  ...
  window.window.document.removeEventListener("marionette-async-response", asyncResponse, false);
...
function executeScript(msg) {
  ...
  if (curContext == "chrome") {
    ...
    var scriptSrc = "with(window) { var __marionetteFunc = function(){" + script +
                    "};  __marionetteFunc.apply(content, __marionetteParams); }";
    try {
...
function executeAsyncScript(msg) {
  ...
  if (curContext == "chrome") {
    ...
    window.window.addEventListener("unload", errUnload, false);
    window.window.document.addEventListener("marionette-async-response", asyncResponse, false);
